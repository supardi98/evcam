        ...
        AnimatedVisibility(
            ...
            Column {
                ProControlPanel(
                    ...
                    onIsoChange = { uiState.isIsoAuto = false; uiState.iso = it; uiState.isProMode = true; uiState.isAeAfLocked = false; uiState.isAwbLocked = false },
                    ...
                    onShutterChange = { uiState.isShutterAuto = false; uiState.shutterSpeed = it; uiState.isProMode = true; uiState.isAeAfLocked = false; uiState.isAwbLocked = false },
                    ...
                    onFocusChange = { uiState.isFocusAuto = false; uiState.focusDistance = it; uiState.isProMode = true; uiState.isAeAfLocked = false; uiState.isAwbLocked = false },
                    onFocusAutoToggle = { uiState.isFocusAuto = !uiState.isFocusAuto },
                    whiteBalance = uiState.whiteBalance,
                    onWhiteBalanceChange = { uiState.whiteBalance = it; uiState.isProMode = true; uiState.isAeAfLocked = false; uiState.isAwbLocked = false },
        ...
        AnimatedVisibility(
            ...
            Column {
                SettingsPanel(
                    ...
                    antiBandingMode = uiState.antiBandingMode,
                    onAntiBandingModeChange = { uiState.antiBandingMode = it },
                    toneProfileMode = uiState.toneProfileMode,
