...
class CameraUiState(
    ...
    // Webcam & Streaming server properties (Auto-enabled for active testing)
    var isWebcamStreaming by mutableStateOf(true)
    ...
    var enableRtspStream by mutableStateOf(true)
